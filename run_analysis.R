#Download the Data
filesPath <- "C:/Users/khanem/datasciencecoursera/UCI HAR Dataset"
setwd(filesPath)
...
write.table(dataTable, "C:/Users/khanem/datasciencecoursera/TidyData.txt", row.name=FALSE)
# Create a Code Book
Write(codebook(dataTable),"TidyData_Codebook.txt")